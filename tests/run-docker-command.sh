...
IMAGE_TAG="v1.58.1-jammy" # This version have to be synchronized with playwright version from package.json

NODE_MODULES_CACHE_DIR="$HOME/.cache/playwright-tools-docker-node-modules"
